...
args = {
    "project_id": "validate_python-0522224015",
}

dag = DAG(
    "validate_python-0522224015",
    default_args=args,
...
op_105b829d_832f_4f54_ab5d_ba464ce15abe = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'validate_python' --cos-endpoint http://90.0.1.37:9000 --cos-bucket dags --cos-directory 'validate_python-0522224015' --cos-dependencies-archive 'python_script-105b829d-832f-4f54-ab5d-ba464ce15abe.tar.gz' --file 'examples/pipelines/setup_validation/python_script.py' "
    ],
