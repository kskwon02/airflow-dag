...
args = {
    "project_id": "untitled-0522123050",
}
...
dag = DAG(
    ...
    description="""
Created with Elyra 3.15.0 pipeline editor using `untitled.py`.
    """,
